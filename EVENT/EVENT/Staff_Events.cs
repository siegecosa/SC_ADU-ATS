...
namespace EVENT
{
    public partial class Staff_Events : Form
    {
        ...
        private void Staff_Events_Load(object sender, EventArgs e)
        {
        ...
        private void bookedEventsData_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            string sql = "SELECT event_status FROM event_details WHERE event_id = @id";
            ...
            Staff_Edit_Event.event_id = event_id;
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT e.event_id AS `Event ID`, CONCAT(c.client_lname, ', ', c.client_fname, ' ', c.client_mi) AS \"Client Name\", e.event_name AS `Event Name`, e.event_date AS `Date of Event`, TIME_FORMAT(e.event_start, '%H:%i') AS `Start Time of Event`, TIME_FORMAT(e.event_end, '%H:%i') AS `End Time of Event`, e.event_status AS `Event Status`, e.event_remarks AS `Event Remarks` FROM event_details e INNER JOIN client_details c ON e.client_id = c.client_id WHERE e.event_id LIKE '%" + search + "%' OR e.event_name LIKE '%" + search + "%' OR e.event_pax LIKE '%" + search + "%' OR e.event_start LIKE '%" + search + "%' OR e.event_end LIKE '%" + search + "%' OR e.book_date LIKE '%" + search + "%' OR CONCAT(c.client_lname, ', ', c.client_fname, ' ', c.client_mi) LIKE '%" + search + "%'";
        ...
        private void searchBox_TextChanged(object sender, EventArgs e)
        {
            ...
            if (all == true)
            {
                sql = "SELECT e.event_id AS `Event ID`, CONCAT(c.client_lname, ', ', c.client_fname, ' ', c.client_mi) AS \"Client Name\", e.event_name AS `Event Name`, e.event_date AS `Date of Event`, TIME_FORMAT(e.event_start, '%H:%i') AS `Start Time of Event`, TIME_FORMAT(e.event_end, '%H:%i') AS `End Time of Event`, e.event_status AS `Event Status`, event_remarks AS `Event Remarks` FROM event_details e INNER JOIN client_details c ON e.client_id = c.client_id WHERE e.event_id LIKE '%" + search + "%' OR e.event_name LIKE '%" + search + "%' OR e.event_pax LIKE '%" + search + "%' OR e.event_start LIKE '%" + search + "%' OR e.event_end LIKE '%" + search + "%' OR e.book_date LIKE '%" + search + "%' OR CONCAT(c.client_lname, ', ', c.client_fname, ' ', c.client_mi) LIKE '%" + search + "%' OR event_remarks LIKE '%" + search + "%'";
                using (MySqlConnection connect = new MySqlConnection(conn))
                {
                    connect.Open();
                    MySqlDataAdapter da = new MySqlDataAdapter(sql, connect);
      ...
      "AND e.event_status = 'Cancelled'";
        ...
        private void compEventFilter_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection connection = new MySqlConnection(conn);
            connection.Open();
            String sql = "SELECT e.event_id AS `Event ID`, CONCAT(c.client_lname, ', ', c.client_fname, ' ', c.client_mi) AS \"Client Name\", e.event_name AS `Event Name`, e.event_date AS `Date of Event`, TIME_FORMAT(e.event_start, '%H:%i') AS `Start Time of Event`, TIME_FORMAT(e.event_end, '%H:%i') AS `End Time of Event`, e.event_status AS `Event Status`, e.event_remarks AS `Event Remarks` FROM event_details e INNER JOIN client_details c ON e.client_id=c.client_id WHERE event_status = 'Completed'";
            MySqlDataAdapter da = new MySqlDataAdapter(sql, connection);
            DataSet ds = new DataSet();
            da.Fill(ds, "event_details");
            bookedEventsData.DataSource = ds.Tables["event_details"].DefaultView;
        ...
        private void ekisEventFilter_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection connection = new MySqlConnection(conn);
            connection.Open();
            String sql = "SELECT e.event_id AS `Event ID`, CONCAT(c.client_lname, ', ', c.client_fname, ' ', c.client_mi) AS \"Client Name\", e.event_name AS `Event Name`, e.event_date AS `Date of Event`, TIME_FORMAT(e.event_start, '%H:%i') AS `Start Time of Event`, TIME_FORMAT(e.event_end, '%H:%i') AS `End Time of Event`, e.event_status AS `Event Status`, e.event_remarks AS `Event Remarks` FROM event_details e INNER JOIN client_details c ON e.client_id=c.client_id WHERE event_status = 'Cancelled'";
            MySqlDataAdapter da = new MySqlDataAdapter(sql, connection);
            DataSet ds = new DataSet();
            da.Fill(ds, "event_details");
            bookedEventsData.DataSource = ds.Tables["event_details"].DefaultView;
        ...
        private void upcEventFilter_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection connection = new MySqlConnection(conn);
            connection.Open();
            String sql = "SELECT e.event_id AS `Event ID`, CONCAT(c.client_lname, ', ', c.client_fname, ' ', c.client_mi) AS \"Client Name\", e.event_name AS `Event Name`, e.event_date AS `Date of Event`, TIME_FORMAT(e.event_start, '%H:%i') AS `Start Time of Event`, TIME_FORMAT(e.event_end, '%H:%i') AS `End Time of Event`, e.event_status AS `Event Status`, e.event_remarks AS `Event Remarks` FROM event_details e INNER JOIN client_details c ON e.client_id=c.client_id WHERE event_status = 'Upcoming'";
            MySqlDataAdapter da = new MySqlDataAdapter(sql, connection);
            DataSet ds = new DataSet();
            da.Fill(ds, "event_details");
            bookedEventsData.DataSource = ds.Tables["event_details"].DefaultView;
        ...
        private void allEventFilter_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection connection = new MySqlConnection(conn);
            connection.Open();
            String sql = "SELECT e.event_id AS `Event ID`, CONCAT(c.client_lname, ', ', c.client_fname, ' ', c.client_mi) AS \"Client Name\", e.event_name AS `Event Name`, e.event_date AS `Date of Event`, TIME_FORMAT(e.event_start, '%H:%i') AS `Start Time of Event`, TIME_FORMAT(e.event_end, '%H:%i') AS `End Time of Event`, e.event_status AS `Event Status`, e.event_remarks AS `Event Remarks` FROM event_details e INNER JOIN client_details c ON e.client_id=c.client_id";
            MySqlDataAdapter da = new MySqlDataAdapter(sql, connection);
            DataSet ds = new DataSet();
            da.Fill(ds, "event_details");
            bookedEventsData.DataSource = ds.Tables["event_details"].DefaultView;
        ...
        {
            if (isClicked == true && isNotNull == true && stat != "Cancelled")
            {
                Staff_Edit_Event edit_Event = new Staff_Edit_Event();
                edit_Event.Show();
                this.Hide();
            }
            else
            {
                if (stat == "Cancelled")
                {
                    MessageBox.Show("Refer to the Manager for cancellation matters.");
                }
                else
                {
